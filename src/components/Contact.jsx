            ...
            <div className="container mx-auto max-w-6xl">
                ...
                <div className="grid lg:grid-cols-5 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div className="p-4 sm:p-6 md:p-10 rounded-3xl md:rounded-[2.5rem] bg-[#18181b]/50 backdrop-blur-xl border border-white/5 shadow-2xl h-full flex flex-col justify-between">
                            <div>
                                ...
                                <div className="space-y-4">
                                    {portfolioData.contact.socialLinks.map((link) => (
                                        <motion.a
                                            ...
                                            whileHover={{ x: 10 }}
                                            className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-primary/30 transition-all group"
                                        >
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                <p className="font-bold text-foreground break-all text-[11px] xs:text-xs sm:text-sm md:text-base select-all">
                    ...
                    <div className="lg:col-span-3">
                        <div className="p-4 sm:p-6 md:p-12 rounded-3xl md:rounded-[2.5rem] bg-[#18181b]/50 backdrop-blur-xl border border-white/5 shadow-2xl relative overflow-hidden h-full">
